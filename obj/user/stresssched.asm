...
sys_env_destroy(envid_t envid)
{
  ...
  800c40:	00 
  800c41:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800c48:	00 
  800c49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c50:	00 
  800c51:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cd2:	00 
  800cd3:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800cda:	00 
  800cdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce2:	00 
  800ce3:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d25:	00 
  800d26:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800d2d:	00 
  800d2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d35:	00 
  800d36:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d78:	00 
  800d79:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800d80:	00 
  800d81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d88:	00 
  800d89:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dcb:	00 
  800dcc:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800dd3:	00 
  800dd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ddb:	00 
  800ddc:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e1e:	00 
  800e1f:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800e26:	00 
  800e27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2e:	00 
  800e2f:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e93:	00 
  800e94:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800e9b:	00 
  800e9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea3:	00 
  800ea4:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
fork(void)
{
  ...
  800ebe:	c7 44 24 08 9b 14 80 	movl   $0x80149b,0x8(%esp)
  800ec5:	00 
  800ec6:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800ecd:	00 
  800ece:	c7 04 24 8f 14 80 00 	movl   $0x80148f,(%esp)
...
sfork(void)
{
  ...
  800ee0:	c7 44 24 08 9a 14 80 	movl   $0x80149a,0x8(%esp)
  800ee7:	00 
  800ee8:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800eef:	00 
  800ef0:	c7 04 24 8f 14 80 00 	movl   $0x80148f,(%esp)
