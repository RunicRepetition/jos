...
sys_env_destroy(envid_t envid)
{
  ...
  800b70:	00 
  800b71:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800b78:	00 
  800b79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b80:	00 
  800b81:	c7 04 24 a1 13 80 00 	movl   $0x8013a1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 a1 13 80 00 	movl   $0x8013a1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c55:	00 
  800c56:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800c5d:	00 
  800c5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c65:	00 
  800c66:	c7 04 24 a1 13 80 00 	movl   $0x8013a1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ca8:	00 
  800ca9:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800cb0:	00 
  800cb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb8:	00 
  800cb9:	c7 04 24 a1 13 80 00 	movl   $0x8013a1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cfb:	00 
  800cfc:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800d03:	00 
  800d04:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0b:	00 
  800d0c:	c7 04 24 a1 13 80 00 	movl   $0x8013a1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d4e:	00 
  800d4f:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800d56:	00 
  800d57:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5e:	00 
  800d5f:	c7 04 24 a1 13 80 00 	movl   $0x8013a1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dc3:	00 
  800dc4:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800dcb:	00 
  800dcc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd3:	00 
  800dd4:	c7 04 24 a1 13 80 00 	movl   $0x8013a1,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800df7:	c7 44 24 08 b0 13 80 	movl   $0x8013b0,0x8(%esp)
  800dfe:	00 
  800dff:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800e06:	00 
  800e07:	c7 04 24 d4 13 80 00 	movl   $0x8013d4,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e49:	c7 04 24 e4 13 80 00 	movl   $0x8013e4,(%esp)
