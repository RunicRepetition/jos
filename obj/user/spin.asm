...
sys_env_destroy(envid_t envid)
{
  ...
  800ba0:	00 
  800ba1:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800ba8:	00 
  800ba9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bb0:	00 
  800bb1:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c32:	00 
  800c33:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800c3a:	00 
  800c3b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c42:	00 
  800c43:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c85:	00 
  800c86:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800c8d:	00 
  800c8e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c95:	00 
  800c96:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cd8:	00 
  800cd9:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800ce0:	00 
  800ce1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce8:	00 
  800ce9:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d2b:	00 
  800d2c:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800d33:	00 
  800d34:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3b:	00 
  800d3c:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d7e:	00 
  800d7f:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800d86:	00 
  800d87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8e:	00 
  800d8f:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800df3:	00 
  800df4:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800dfb:	00 
  800dfc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e03:	00 
  800e04:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
fork(void)
{
  ...
  800e1e:	c7 44 24 08 7b 14 80 	movl   $0x80147b,0x8(%esp)
  800e25:	00 
  800e26:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800e2d:	00 
  800e2e:	c7 04 24 6f 14 80 00 	movl   $0x80146f,(%esp)
...
sfork(void)
{
  ...
  800e40:	c7 44 24 08 7a 14 80 	movl   $0x80147a,0x8(%esp)
  800e47:	00 
  800e48:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800e4f:	00 
  800e50:	c7 04 24 6f 14 80 00 	movl   $0x80146f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e88:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
