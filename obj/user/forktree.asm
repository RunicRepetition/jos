...
sys_env_destroy(envid_t envid)
{
  ...
  800bd0:	00 
  800bd1:	c7 44 24 08 e4 13 80 	movl   $0x8013e4,0x8(%esp)
  800bd8:	00 
  800bd9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be0:	00 
  800be1:	c7 04 24 01 14 80 00 	movl   $0x801401,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c62:	00 
  800c63:	c7 44 24 08 e4 13 80 	movl   $0x8013e4,0x8(%esp)
  800c6a:	00 
  800c6b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c72:	00 
  800c73:	c7 04 24 01 14 80 00 	movl   $0x801401,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cb5:	00 
  800cb6:	c7 44 24 08 e4 13 80 	movl   $0x8013e4,0x8(%esp)
  800cbd:	00 
  800cbe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc5:	00 
  800cc6:	c7 04 24 01 14 80 00 	movl   $0x801401,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d08:	00 
  800d09:	c7 44 24 08 e4 13 80 	movl   $0x8013e4,0x8(%esp)
  800d10:	00 
  800d11:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d18:	00 
  800d19:	c7 04 24 01 14 80 00 	movl   $0x801401,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d5b:	00 
  800d5c:	c7 44 24 08 e4 13 80 	movl   $0x8013e4,0x8(%esp)
  800d63:	00 
  800d64:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6b:	00 
  800d6c:	c7 04 24 01 14 80 00 	movl   $0x801401,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dae:	00 
  800daf:	c7 44 24 08 e4 13 80 	movl   $0x8013e4,0x8(%esp)
  800db6:	00 
  800db7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbe:	00 
  800dbf:	c7 04 24 01 14 80 00 	movl   $0x801401,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e23:	00 
  800e24:	c7 44 24 08 e4 13 80 	movl   $0x8013e4,0x8(%esp)
  800e2b:	00 
  800e2c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e33:	00 
  800e34:	c7 04 24 01 14 80 00 	movl   $0x801401,(%esp)
...
fork(void)
{
  ...
  800e4e:	c7 44 24 08 1b 14 80 	movl   $0x80141b,0x8(%esp)
  800e55:	00 
  800e56:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800e5d:	00 
  800e5e:	c7 04 24 0f 14 80 00 	movl   $0x80140f,(%esp)
...
sfork(void)
{
  ...
  800e70:	c7 44 24 08 1a 14 80 	movl   $0x80141a,0x8(%esp)
  800e77:	00 
  800e78:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800e7f:	00 
  800e80:	c7 04 24 0f 14 80 00 	movl   $0x80140f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800eb8:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
