...
sys_env_destroy(envid_t envid)
{
  ...
  80011f:	00 
  800120:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  800127:	00 
  800128:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012f:	00 
  800130:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b1:	00 
  8001b2:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  8001b9:	00 
  8001ba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001c1:	00 
  8001c2:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800204:	00 
  800205:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  80020c:	00 
  80020d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800214:	00 
  800215:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800257:	00 
  800258:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  80025f:	00 
  800260:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800267:	00 
  800268:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002aa:	00 
  8002ab:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  8002b2:	00 
  8002b3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002ba:	00 
  8002bb:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002fd:	00 
  8002fe:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  800305:	00 
  800306:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80030d:	00 
  80030e:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800372:	00 
  800373:	c7 44 24 08 ea 10 80 	movl   $0x8010ea,0x8(%esp)
  80037a:	00 
  80037b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800382:	00 
  800383:	c7 04 24 07 11 80 00 	movl   $0x801107,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003ce:	c7 04 24 18 11 80 00 	movl   $0x801118,(%esp)
  ...
  8003e4:	e8 51 00 00 00       	call   80043a <vcprintf>
	cprintf("\n");
  8003e9:	c7 04 24 3b 11 80 00 	movl   $0x80113b,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800476:	e8 b3 01 00 00       	call   80062e <vprintfmt>
	sys_cputs(b.buf, b.idx);
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e25:	c7 44 24 08 84 13 80 	movl   $0x801384,0x8(%esp)
  800e2c:	00 
  800e2d:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800e34:	00 
  800e35:	c7 04 24 a8 13 80 00 	movl   $0x8013a8,(%esp)
  800e3c:	e8 61 f5 ff ff       	call   8003a2 <_panic>
	}
