...
sys_env_destroy(envid_t envid)
{
  ...
  800cc0:	00 
  800cc1:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800cc8:	00 
  800cc9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd0:	00 
  800cd1:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d52:	00 
  800d53:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800d5a:	00 
  800d5b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d62:	00 
  800d63:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800da5:	00 
  800da6:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800dad:	00 
  800dae:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800db5:	00 
  800db6:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800df8:	00 
  800df9:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800e00:	00 
  800e01:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e08:	00 
  800e09:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e4b:	00 
  800e4c:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800e53:	00 
  800e54:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e5b:	00 
  800e5c:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e9e:	00 
  800e9f:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800ea6:	00 
  800ea7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eae:	00 
  800eaf:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800f13:	00 
  800f14:	c7 44 24 08 e4 15 80 	movl   $0x8015e4,0x8(%esp)
  800f1b:	00 
  800f1c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f23:	00 
  800f24:	c7 04 24 01 16 80 00 	movl   $0x801601,(%esp)
...
fork(void)
{
  ...
  800f3e:	c7 44 24 08 1b 16 80 	movl   $0x80161b,0x8(%esp)
  800f45:	00 
  800f46:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800f4d:	00 
  800f4e:	c7 04 24 0f 16 80 00 	movl   $0x80160f,(%esp)
...
sfork(void)
{
  ...
  800f60:	c7 44 24 08 1a 16 80 	movl   $0x80161a,0x8(%esp)
  800f67:	00 
  800f68:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800f6f:	00 
  800f70:	c7 04 24 0f 16 80 00 	movl   $0x80160f,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800f82:	c7 44 24 08 30 16 80 	movl   $0x801630,0x8(%esp)
  800f89:	00 
  800f8a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800f91:	00 
  800f92:	c7 04 24 49 16 80 00 	movl   $0x801649,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800fa4:	c7 44 24 08 53 16 80 	movl   $0x801653,0x8(%esp)
  800fab:	00 
  800fac:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800fb3:	00 
  800fb4:	c7 04 24 49 16 80 00 	movl   $0x801649,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801024:	c7 04 24 6c 16 80 00 	movl   $0x80166c,(%esp)
