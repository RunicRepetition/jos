...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017c:	c7 04 24 f8 11 80 00 	movl   $0x8011f8,(%esp)
  ...
  800192:	e8 51 00 00 00       	call   8001e8 <vcprintf>
	cprintf("\n");
  800197:	c7 04 24 9e 11 80 00 	movl   $0x80119e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 1b 12 80 00 	movsbl 0x80121b(%eax),%eax
...
008003de <vprintfmt>:
{
  ...
  800463:	ff 24 8d e0 12 80 00 	jmp    *0x8012e0(,%ecx,4)
  ...
  800500:	8b 14 85 40 14 80 00 	mov    0x801440(,%eax,4),%edx
  ...
  80052f:	c7 44 24 08 3c 12 80 	movl   $0x80123c,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 2c 12 80 00       	mov    $0x80122c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c30:	00 
  800c31:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800c38:	00 
  800c39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c40:	00 
  800c41:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc2:	00 
  800cc3:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d15:	00 
  800d16:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800d1d:	00 
  800d1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d25:	00 
  800d26:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d68:	00 
  800d69:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800d70:	00 
  800d71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d78:	00 
  800d79:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	00 
  800dbc:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800dc3:	00 
  800dc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcb:	00 
  800dcc:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0e:	00 
  800e0f:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800e16:	00 
  800e17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1e:	00 
  800e1f:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e83:	00 
  800e84:	c7 44 24 08 64 14 80 	movl   $0x801464,0x8(%esp)
  800e8b:	00 
  800e8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e93:	00 
  800e94:	c7 04 24 81 14 80 00 	movl   $0x801481,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eb7:	c7 44 24 08 90 14 80 	movl   $0x801490,0x8(%esp)
  800ebe:	00 
  800ebf:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800ec6:	00 
  800ec7:	c7 04 24 b4 14 80 00 	movl   $0x8014b4,(%esp)
  800ece:	e8 7d f2 ff ff       	call   800150 <_panic>
	}
