...
sys_env_destroy(envid_t envid)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d12:	00 
  800d13:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800d1a:	00 
  800d1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d22:	00 
  800d23:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800db8:	00 
  800db9:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800dc0:	00 
  800dc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dc8:	00 
  800dc9:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e0b:	00 
  800e0c:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800e13:	00 
  800e14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1b:	00 
  800e1c:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e5e:	00 
  800e5f:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800e66:	00 
  800e67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6e:	00 
  800e6f:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ed3:	00 
  800ed4:	c7 44 24 08 04 15 80 	movl   $0x801504,0x8(%esp)
  800edb:	00 
  800edc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ee3:	00 
  800ee4:	c7 04 24 21 15 80 00 	movl   $0x801521,(%esp)
...
fork(void)
{
  ...
  800efe:	c7 44 24 08 3b 15 80 	movl   $0x80153b,0x8(%esp)
  800f05:	00 
  800f06:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800f0d:	00 
  800f0e:	c7 04 24 2f 15 80 00 	movl   $0x80152f,(%esp)
...
sfork(void)
{
  ...
  800f20:	c7 44 24 08 3a 15 80 	movl   $0x80153a,0x8(%esp)
  800f27:	00 
  800f28:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800f2f:	00 
  800f30:	c7 04 24 2f 15 80 00 	movl   $0x80152f,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800f42:	c7 44 24 08 50 15 80 	movl   $0x801550,0x8(%esp)
  800f49:	00 
  800f4a:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800f51:	00 
  800f52:	c7 04 24 69 15 80 00 	movl   $0x801569,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800f64:	c7 44 24 08 73 15 80 	movl   $0x801573,0x8(%esp)
  800f6b:	00 
  800f6c:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800f73:	00 
  800f74:	c7 04 24 69 15 80 00 	movl   $0x801569,(%esp)
