...
sys_env_destroy(envid_t envid)
{
  ...
  800be0:	00 
  800be1:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800be8:	00 
  800be9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf0:	00 
  800bf1:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c72:	00 
  800c73:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800c7a:	00 
  800c7b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c82:	00 
  800c83:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cc5:	00 
  800cc6:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800ccd:	00 
  800cce:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd5:	00 
  800cd6:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d18:	00 
  800d19:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800d20:	00 
  800d21:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d28:	00 
  800d29:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d6b:	00 
  800d6c:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800d73:	00 
  800d74:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d7b:	00 
  800d7c:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dbe:	00 
  800dbf:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800dc6:	00 
  800dc7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dce:	00 
  800dcf:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e33:	00 
  800e34:	c7 44 24 08 84 14 80 	movl   $0x801484,0x8(%esp)
  800e3b:	00 
  800e3c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e43:	00 
  800e44:	c7 04 24 a1 14 80 00 	movl   $0x8014a1,(%esp)
...
fork(void)
{
  ...
  800e5e:	c7 44 24 08 bb 14 80 	movl   $0x8014bb,0x8(%esp)
  800e65:	00 
  800e66:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800e6d:	00 
  800e6e:	c7 04 24 af 14 80 00 	movl   $0x8014af,(%esp)
...
sfork(void)
{
  ...
  800e80:	c7 44 24 08 ba 14 80 	movl   $0x8014ba,0x8(%esp)
  800e87:	00 
  800e88:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800e8f:	00 
  800e90:	c7 04 24 af 14 80 00 	movl   $0x8014af,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800ea2:	c7 44 24 08 d0 14 80 	movl   $0x8014d0,0x8(%esp)
  800ea9:	00 
  800eaa:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800eb1:	00 
  800eb2:	c7 04 24 e9 14 80 00 	movl   $0x8014e9,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800ec4:	c7 44 24 08 f3 14 80 	movl   $0x8014f3,0x8(%esp)
  800ecb:	00 
  800ecc:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800ed3:	00 
  800ed4:	c7 04 24 e9 14 80 00 	movl   $0x8014e9,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f44:	c7 04 24 0c 15 80 00 	movl   $0x80150c,(%esp)
