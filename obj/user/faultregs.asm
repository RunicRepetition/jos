...
pgfault(struct UTrapframe *utf)
{
  ...
  800425:	c7 44 24 04 9f 16 80 	movl   $0x80169f,0x4(%esp)
  80042c:	00 
  80042d:	c7 04 24 ad 16 80 00 	movl   $0x8016ad,(%esp)
  800434:	b9 60 20 80 00       	mov    $0x802060,%ecx
  800439:	ba 98 16 80 00       	mov    $0x801698,%edx
  ...
  80046c:	c7 44 24 08 b4 16 80 	movl   $0x8016b4,0x8(%esp)
  800473:	00 
  800474:	c7 44 24 04 5c 00 00 	movl   $0x5c,0x4(%esp)
  80047b:	00 
  80047c:	c7 04 24 87 16 80 00 	movl   $0x801687,(%esp)
...
umain(int argc, char **argv)
{
  ...
  800560:	c7 04 24 14 17 80 00 	movl   $0x801714,(%esp)
  ...
  800576:	c7 44 24 04 c7 16 80 	movl   $0x8016c7,0x4(%esp)
  80057d:	00 
  80057e:	c7 04 24 d8 16 80 00 	movl   $0x8016d8,(%esp)
  800585:	b9 20 20 80 00       	mov    $0x802020,%ecx
  80058a:	ba 98 16 80 00       	mov    $0x801698,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800623:	c7 04 24 40 17 80 00 	movl   $0x801740,(%esp)
  ...
  800639:	e8 51 00 00 00       	call   80068f <vcprintf>
	cprintf("\n");
  80063e:	c7 04 24 50 16 80 00 	movl   $0x801650,(%esp)
...
sys_env_destroy(envid_t envid)
{
  ...
  8010d0:	00 
  8010d1:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  8010d8:	00 
  8010d9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8010e0:	00 
  8010e1:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  801162:	00 
  801163:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  80116a:	00 
  80116b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801172:	00 
  801173:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8011b5:	00 
  8011b6:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  8011bd:	00 
  8011be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011c5:	00 
  8011c6:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801208:	00 
  801209:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  801210:	00 
  801211:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801218:	00 
  801219:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80125b:	00 
  80125c:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  801263:	00 
  801264:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80126b:	00 
  80126c:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8012ae:	00 
  8012af:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  8012b6:	00 
  8012b7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012be:	00 
  8012bf:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  801323:	00 
  801324:	c7 44 24 08 a4 19 80 	movl   $0x8019a4,0x8(%esp)
  80132b:	00 
  80132c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801333:	00 
  801334:	c7 04 24 c1 19 80 00 	movl   $0x8019c1,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801357:	c7 44 24 08 d0 19 80 	movl   $0x8019d0,0x8(%esp)
  80135e:	00 
  80135f:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  801366:	00 
  801367:	c7 04 24 f4 19 80 00 	movl   $0x8019f4,(%esp)
  80136e:	e8 84 f2 ff ff       	call   8005f7 <_panic>
	}
