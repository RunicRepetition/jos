...
sys_env_destroy(envid_t envid)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca2:	00 
  800ca3:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800caa:	00 
  800cab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb2:	00 
  800cb3:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d9b:	00 
  800d9c:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800da3:	00 
  800da4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dab:	00 
  800dac:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dee:	00 
  800def:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800df6:	00 
  800df7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfe:	00 
  800dff:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e63:	00 
  800e64:	c7 44 24 08 44 14 80 	movl   $0x801444,0x8(%esp)
  800e6b:	00 
  800e6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e73:	00 
  800e74:	c7 04 24 61 14 80 00 	movl   $0x801461,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e97:	c7 44 24 08 70 14 80 	movl   $0x801470,0x8(%esp)
  800e9e:	00 
  800e9f:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800ea6:	00 
  800ea7:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
