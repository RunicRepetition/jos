...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 3c             	sub    $0x3c,%esp
	...
	i = 0;
	if ((who = sfork()) != 0) {
  80003c:	e8 79 0e 00 00       	call   800eba <sfork>
  ...
  80005b:	c7 04 24 40 12 80 00 	movl   $0x801240,(%esp)
  ...
  800077:	c7 04 24 5a 12 80 00 	movl   $0x80125a,(%esp)
  ...
  8000a1:	e8 58 0e 00 00       	call   800efe <ipc_send>
	}
  ...
  8000bc:	e8 1b 0e 00 00       	call   800edc <ipc_recv>
  ...
  8000f1:	c7 04 24 70 12 80 00 	movl   $0x801270,(%esp)
  ...
  80012d:	e8 cc 0d 00 00       	call   800efe <ipc_send>
		if (val == 10)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cf:	e8 dc 0c 00 00       	call   800fb0 <__udivdi3>
  ...
  80032f:	e8 ac 0d 00 00       	call   8010e0 <__umoddi3>
  800334:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800338:	0f be 80 a0 12 80 00 	movsbl 0x8012a0(%eax),%eax
...
008003ce <vprintfmt>:
{
  ...
  800453:	ff 24 8d 60 13 80 00 	jmp    *0x801360(,%ecx,4)
  ...
  80051f:	c7 44 24 08 c1 12 80 	movl   $0x8012c1,0x8(%esp)
  800526:	00 
  ...
  800551:	b8 b1 12 80 00       	mov    $0x8012b1,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c20:	00 
  800c21:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800c28:	00 
  800c29:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c30:	00 
  800c31:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb2:	00 
  800cb3:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800cba:	00 
  800cbb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc2:	00 
  800cc3:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d05:	00 
  800d06:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800d0d:	00 
  800d0e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d15:	00 
  800d16:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d58:	00 
  800d59:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800d60:	00 
  800d61:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d68:	00 
  800d69:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dab:	00 
  800dac:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800db3:	00 
  800db4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dbb:	00 
  800dbc:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dfe:	00 
  800dff:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800e06:	00 
  800e07:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0e:	00 
  800e0f:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e73:	00 
  800e74:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800e7b:	00 
  800e7c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e83:	00 
  800e84:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
fork(void)
{
  ...
  800e9e:	c7 44 24 08 1b 15 80 	movl   $0x80151b,0x8(%esp)
  800ea5:	00 
  800ea6:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800ead:	00 
  800eae:	c7 04 24 0f 15 80 00 	movl   $0x80150f,(%esp)
...
sfork(void)
{
  ...
  800ec0:	c7 44 24 08 1a 15 80 	movl   $0x80151a,0x8(%esp)
  800ec7:	00 
  800ec8:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800ecf:	00 
  800ed0:	c7 04 24 0f 15 80 00 	movl   $0x80150f,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800ee2:	c7 44 24 08 30 15 80 	movl   $0x801530,0x8(%esp)
  800ee9:	00 
  800eea:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800ef1:	00 
  800ef2:	c7 04 24 49 15 80 00 	movl   $0x801549,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800f04:	c7 44 24 08 53 15 80 	movl   $0x801553,0x8(%esp)
  800f0b:	00 
  800f0c:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  800f13:	00 
  800f14:	c7 04 24 49 15 80 00 	movl   $0x801549,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f84:	c7 04 24 6c 15 80 00 	movl   $0x80156c,(%esp)
  800f8b:	e8 b6 f2 ff ff       	call   800246 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f90:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f94:	8b 45 10             	mov    0x10(%ebp),%eax
  800f97:	89 04 24             	mov    %eax,(%esp)
  800f9a:	e8 46 f2 ff ff       	call   8001e5 <vcprintf>
	cprintf("\n");
  800f9f:	c7 04 24 58 12 80 00 	movl   $0x801258,(%esp)
  800fa6:	e8 9b f2 ff ff       	call   800246 <cprintf>
